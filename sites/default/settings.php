 ...
 * @endcode
 */
$settings['hash_salt'] = 'r5Yi94cga7gHPbTRiVdwoLinIaWyFXVDPrFqsXvZfAx22FhnWDqK_13oHaof0jOFVXVCotQL3A';
...
$settings['http_client_config']['proxy']['http'] = 'http://ifarre:ClaveV1-@proxy.indra.es:8080';
 $settings['http_client_config']['proxy']['https'] = 'https://ifarre:ClaveV1-@proxy.indra.es:8080';
 $settings['http_client_config']['proxy']['no'] = ['127.0.0.1', 'localhost'];
...
$databases['default']['default'] = array (
  'database' => 'ignaciofarre',
  'username' => 'ignaciofarre',
  'password' => 'jFmk*809',
  'prefix' => '',
  'host' => 'localhost',
  'port' => '3306',
...
$config_directories['sync'] = 'sites/default/files/config_h-uAXzHxXc1WEwaKJJUTd-SK2p4jNEfSRDuAAisq-cSan_R_dd6yLSk-RUJWQA2dOyoRmBAJQQ/sync';
