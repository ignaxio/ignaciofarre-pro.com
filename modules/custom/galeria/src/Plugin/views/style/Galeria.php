<?php
namespace Drupal\galeria\Plugin\views\style;
 ...
 * @ViewsStyle(
 *   id = "galeria",
 *   title = @Translation("GALERIA"),
 *   help = @Translation("View plugin to display nodes has a galeria."),
 *   theme = "views_view_galeria",
 *   display_types = { "normal" }
 * )
 */
class Galeria extends StylePluginBase {
  ...
  protected function defineOptions() {
    ...
    $options['path'] = array('default' => 'galeria');
    return $options;
  }
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    $form['path'] = array(
      '#type' => 'textfield',
      '#title' => t('Link path'),
      '#default_value' => (isset($this->options['path'])) ? $this->options['path'] : 'galeria',
      '#description' => t('Path prefix for each GALERIA link, eg. example.com<strong>/galeria/</strong>2015/10.'),
    );
    ...
    $form['classes'] = array(
      '#type' => 'textfield',
      '#title' => t('CSS classes'),
      '#default_value' => (isset($this->options['classes'])) ? $this->options['classes'] : 'view-galeria',
